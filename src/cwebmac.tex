...
\else%
  \def\pdflink#1#2{%
    \setbox0=\hbox{\special{pdf: bc [ \pdflinkcolor ]}{#1}%
...
%
%
\def\ty#1{#1} % fake typewriter font for titles
\outer\def\M#1{\MN{#1}\ifon\vfil\penalty-100\vfilneg % beginning of section
  \vskip\intersecskip\startsection\ignorespaces}
\outer\def\N#1#2#3.{\gdepth=#1%
  \gtitle={#3}\MN{#2}% beginning of starred section
